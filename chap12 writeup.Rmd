...
1. There are a whole bunch of levels, and some may not be different from others

2. There are varying amounts of data collected for each group - such that groups with small amounts 
of data can still be used.
